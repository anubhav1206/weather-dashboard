...
<div
  id="cards"
  key={item.key}
  class="bg-darkPurple flex flex-col transition-transform duration-300 ease-in-out hover:translate-y-1 active:translate-y-2 min-w-[230px] sm:min-w-[300px] rounded-xl sm:rounded-3xl md:rounded-[30px] px-4 py-6 sm:px-6 sm:py-8 select-none"
>
